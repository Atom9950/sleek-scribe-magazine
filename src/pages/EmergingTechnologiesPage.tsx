...
const EmergingTechnologiesPage = () => {
  const slug = 'banglar-prati-bangalir-udashinota'; // Article slug
      ...
      <section className="max-w-4xl mx-auto px-6 py-12">
        <article className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <h1 className='text-xl font-serif justify-center text-center py-2 '>পৃষ্ঠা-২</h1>
            ...
            <h1 className='text-xl font-serif justify-center text-center py-2 '>পৃষ্ঠা-৩</h1>
          </div>
          ...
          <div className="pt-12">
            ...
            <form onSubmit={handleSubmitComment} className="mb-8">
              <textarea
                ...
                className="w-full px-4 py-3 bg-[#f0f0f0] border-b border-black rounded-lg focus:outline-none focus:ring-1 focus:ring-black"
